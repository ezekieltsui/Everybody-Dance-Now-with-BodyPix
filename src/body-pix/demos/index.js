...
import {drawMask, toColoredPartMask} from './node_modules/@tensorflow-models/body-pix/dist/output_rendering_util'
...
async function loadVideo(cameraLabel) {
  try {
    ...
    //state.video = document.getElementById('image')
...
const defaultResNetInternalResolution = 'full';
  ...
  async function bodySegmentationFrame() {
    ...
    switch (guiState.estimate) {
      ...
      case 'partmap':
        ...
        const coloredPartImageData = toColoredPartMask(
    ...
    // downloadImg(dataURL,padding(num, 5)+".png")
    // num++;
